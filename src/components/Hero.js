      ...
      <div className="container">
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <span className="hero-label animate-in animate-delay-1">Full-Stack AI Engineer</span>
            ...
            <p className="hero-description animate-in animate-delay-3">
              I build production software with AI-native development workflows.
              Specialized in React, TypeScript, .NET, and using AI agents across the
              software development lifecycle — from architecture to deployment.
            </p>
            ...
            <div className="hero-meta animate-in animate-delay-4">
              ...
              <div className="hero-stat">
                ...
                <div className="hero-stat-label">Native Workflow</div>
              </div>
              <div className="hero-stat">
                <div className="hero-stat-number">E2E</div>
